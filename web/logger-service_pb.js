...
proto.pplogger.StreamErrorsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    startfrom: jspb.Message.getFieldWithDefault(msg, 1, 0)
  };
...
/**
 * optional int32 startFrom = 1;
 * @return {number}
 */
proto.pplogger.StreamErrorsRequest.prototype.getStartfrom = function() {
 ...
 */
proto.pplogger.StreamErrorsRequest.prototype.setStartfrom = function(value) {
